...
export const SITE_KEYWORDS = [
  ...
  "rug check",
  "token risk analysis",
  "contract ownership and proxy check",
  "deployer reputation",
  "wallet analysis",
...
export function softwareApplicationLd() {
  return {
    ...
    featureList: [
      ...
      "Conversational token rug checks that report what was not checked as unknown, never as a pass",
...
/* A reader-facing blog post, as opposed to techArticleLd's developer documentation.
   datePublished and the absolute image URL are what make it eligible for the Article
   rich result; author and publisher both resolve to the one Organization node. */
export function articleLd({ title, description, path, datePublished, dateModified, image, section }) {
  return {
    "@context": "https://schema.org",
    "@type": "Article",
    "@id": `${absoluteUrl(path)}/#article`,
