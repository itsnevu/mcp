 ...
 * backend responds. Replace the /api/chat route with the live RobinX engine +
...
export function demoAgent(text) {
  ...
  return {
    kind: "text",
    text: "I'm **BUGGLO**, your intelligence layer for **Robinhood Chain** — 𝕏 sentiment, rug checks, wallet analysis, and market moves.\n\nAnswers currently use **demo data** unless the live RobinX engine + RobinX MCP backend is configured.\n\nTry `/trending`, `/rugcheck 0x…`, `/sentiment $HOOD`, or `/wallet 0x…`",
  };
}
